...
> **NOTE**: I recommend you also read the [errors](/errors) page which will give you a bunch of options for [creating custom error messages](/errors/formatting#custom-error-messages) which you can use in conjunction with i18n.
