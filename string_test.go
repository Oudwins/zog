		...
		"not email failure": {
			...
			expectedErrMap: internals.ZogIssueList{
				&internals.ZogIssue{
					...
					Params:  nil,
					Dtype:   "string",
					Value:   internals.PtrOf("test@test.com"),
		...
		"not url failure": {
			...
			expectedErrMap: internals.ZogIssueList{
				&internals.ZogIssue{
					Code:    "not_url",
					Dtype:   "string",
					Value:   internals.PtrOf("https://google.com"),
		...
		"not has prefix failure": {
			...
			expectedErrMap: internals.ZogIssueList{
				&internals.ZogIssue{
					...
					Dtype:   "string",
					Value:   internals.PtrOf("test_value"),
